...
const Navigation: FC<Props> = ({ mobileNavOpen, setMobileNavOpen }) => {
    ...
    return (
        <>
            ...
            ></div>
            {/* Navigation */}
            <ul className={`fixed top-[54px] lg:top-0 bottom-0 left-${mobileNavOpen ? '0' : '[-250px]'} lg:left-0 w-[230px] py-3 overflow-y-auto transition-all z-[9998] lg:z-[1] border-r border-zinc-900/10 text-zinc-900 bg-white lg:bg-transparent dark:text-white dark:border-white/10 dark:bg-zinc-900  lg:dark:bg-transparent`}>
